...
-- Calls / Whistles (呼び笛)
INSERT INTO items (name, category, weight, weight_bonus, description) VALUES
('エルクコール', 'call', 0.50, 0, 'エルクを引き寄せる呼び笛。発情期に特に効果的。'),
('ディアコール', 'call', 0.50, 0, 'シカを引き寄せる呼び笛。'),
('モースコール', 'call', 0.50, 0, 'ヘラジカを引き寄せる呼び笛。'),
('ターキーコール', 'call', 0.30, 0, '七面鳥を引き寄せる呼び笛。'),
('ダックコール', 'call', 0.30, 0, 'カモを引き寄せる呼び笛。'),
('コヨーテコール', 'call', 0.40, 0, 'コヨーテを引き寄せる呼び笛。'),
('ベアコール', 'call', 0.60, 0, 'クマを引き寄せる呼び笛。'),
('バイソンコール', 'call', 0.60, 0, 'バイソンを引き寄せる呼び笛。'),
('ワイルドボアコール', 'call', 0.40, 0, 'イノシシを引き寄せる呼び笛。'),
('ウォータバッファローコール', 'call', 0.50, 0, 'スイギュウを引き寄せる呼び笛。');
